...
def test_get_slots_in_week_by_booking_empty(create_admin_id):
    booking_slots = get_slots_from_db_for_schedule(create_admin_id, "2021-03-02", "booking", 7)
    assert booking_slots == []


def test_get_slots_in_week_by_booking(create_admin_id):
...
def test_get_slots_in_week_by_available_empty(create_admin_id):
    available_slots = get_slots_from_db_for_schedule(create_admin_id, "2021-02-03", "available", 7)
    assert available_slots == []


def test_get_slots_in_week_by_available(create_admin_id):
