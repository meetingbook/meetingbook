...
from backend.tools.for_test.func_for_test_db import clean_table_slots, create_test_table
import pytest
...
def test_get_slots_day(create_test_table_with_data_for_get_slots):
    ...
    assert get_slots.get_slots(params_for_get)[0] == '2021-03-02 00:00:00 - 2021-03-03 00:00:00'
...
def test_get_slots_day_booking(create_test_table_with_data_for_get_slots):
    ...
    assert get_slots.get_slots(params_for_get)[0] == '2021-03-02 10:00:00 - 2021-03-03 00:00:00'
