...
def test_sanity():
    ...
    assert run_with_args("get_slots -d 2021-05-03 -f free") == b'''2021-05-03 10:00:00 - 2021-05-03 10:15:00\r\n2021-05-03 11:00:00 - 2021-05-04 00:15:00\r\n'''                                                              
    ...
    assert run_with_args("get_slots -w 2021-05-03 -f free") == b'''2021-05-03 10:00:00 - 2021-05-03 10:15:00\r\n2021-05-03 11:00:00 - 2021-05-10 00:15:00\r\n'''
